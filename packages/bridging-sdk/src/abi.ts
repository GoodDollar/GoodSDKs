export const MESSAGE_PASSING_BRIDGE_ABI = [
  {
    "inputs": [
      { "internalType": "address", "name": "axlGateway", "type": "address" },
      { "internalType": "address", "name": "axlGasReceiver", "type": "address" },
      { "internalType": "address", "name": "lzEndpoint", "type": "address" },
      { "internalType": "bool", "name": "isTestnet", "type": "bool" }
    ],
  ...
  { "inputs": [], "name": "InvalidAddressString", "type": "error" },
  {
    "inputs": [
  ...
  { "inputs": [], "name": "MISSING_FEE", "type": "error" },
  {
    "inputs": [
  ...
  { "inputs": [], "name": "TRANSFER", "type": "error" },
  { "inputs": [], "name": "TRANSFER_FROM", "type": "error" },
  {
    "inputs": [
      { "internalType": "uint256", "name": "chainId", "type": "uint256" }
    ],
  ...
  },
  {
    ...
    "outputs": [
      { "internalType": "uint256", "name": "lastTransferReset", "type": "uint256" },
      { "internalType": "uint256", "name": "bridged24Hours", "type": "uint256" }
    ],
    "stateMutability": "view",
    "type": "function"
  },
  ...
  },
  {
    ...
    "outputs": [
      ...
      { "internalType": "uint256", "name": "txLimit", "type": "uint256" },
      { "internalType": "uint256", "name": "accountDailyLimit", "type": "uint256" },
      { "internalType": "uint256", "name": "minAmount", "type": "uint256" },
      { "internalType": "bool", "name": "onlyWhitelisted", "type": "bool" }
    ],
    "stateMutability": "view",
    "type": "function"
  },
  ...
  },
  {
    ...
    "name": "canBridge",
    "outputs": [
      { "internalType": "bool", "name": "isWithinLimit", "type": "bool" },
  ...
  },
  {
    "inputs": [
      ...
      { "internalType": "uint256", "name": "_normalizedAmount", "type": "uint256" },
  ...
  },
  {
    ...
    "name": "faucet",
    "outputs": [
      { "internalType": "contract IFaucet", "name": "", "type": "address" }
    ],
    "stateMutability": "view",
    "type": "function"
  },
  ...
  {
    "inputs": [
      { "internalType": "bytes32[]", "name": "bridgeKeys", "type": "bytes32[]" },
