...
import { celo, fuse, xdc, base, celoAlfajores, type AppKitNetwork } from "@reown/appkit/networks"
...
const networks: [AppKitNetwork, ...AppKitNetwork[]] = [celo, fuse, xdc, base, celoAlfajores]
