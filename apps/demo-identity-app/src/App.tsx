...
import { StreamingTestPage } from "./components/StreamingTestPage"
  ...
  return (
    <TamaguiProvider config={tamaguiConfig}>
      ...
      >
        ...
        >
          <Link to="/" style={{ textDecoration: "none" }}>
            <View
              padding="$3"
              backgroundColor={
                location.pathname === "/" ? "$blue10" : "transparent"
              }
              borderRadius="$3"
            >
              <Text
                color={location.pathname === "/" ? "white" : "$gray11"}
                fontWeight="600"
              >
                🪪 Identity
              </Text>
          ...
          <Link to="/streaming" style={{ textDecoration: "none" }}>
            <View
              padding="$3"
              backgroundColor={
                location.pathname === "/streaming" ? "$blue10" : "transparent"
              }
              borderRadius="$3"
            >
              <Text
                color={location.pathname === "/streaming" ? "white" : "$gray11"}
                fontWeight="600"
              >
                🌊 Streaming
              </Text>
        ...
        <Routes>
          <Route path="/streaming" element={<StreamingTestPage />} />
          <Route
            path="/"
            element={
              <>
